...
export default class DataUtils {
    ...
    getEmployeeByEmployeeId(id: string): Cypress.Chainable<EmployeeData> {
        return cy.request(`/api/v2/pim/employees?limit=50&offset=0&model=detailed&employeeId=${id}&includeEmployees=onlyCurrent&sortField=employee.firstName&sortOrder=ASC`).then((res) => {
